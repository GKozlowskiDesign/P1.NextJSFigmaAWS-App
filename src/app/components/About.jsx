  ...
  return (
        <section>
              ...
              <div className="w-full h-4 bg-green-400 rounded-tr-3xl"></div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 bg-white pb-20 rounded-b-3xl border-b-4 border-black">
                      ...
                      <div className="col-span-1 pt-20 p-10">
                            ...
                            <p className="text-xs md:text-lg font-light pt-4 tracking-wider mb-10 md:text-black">Our core mission is as ambitious as it is vital to ensure that blockchain is seamlessly integrated into the fabric of society, thereby fostering benefits for all of humanity.</p>            
                            <p className="text-xs md:text-lg font-light pt-2 tracking-wider mb-10 md:text-black">Our core mission is as ambitious as it is vital to ensure that blockchain is seamlessly integrated into the fabric of society, thereby fostering benefits for all of humanity.</p>            
                      ...
                      <h1 className="text-4xl lg:text-5xl pl-2  text-black border-l-4 border-indigo-600">Vision</h1>
                            ...
                            <ul className="mt-6">
                            <li><h3 className="underline pt-2 cursor-pointer hover:text-indigo-300 hover:font-bold mx-auto p-1 justify-center text-lg md:text-indigo-600">Read Whitepaper</h3></li>
                            <li><h3 className="underline pt-2 cursor-pointer  hover:text-indigo-300 hover:font-bold mx-auto p-1 justify-center text-lg md:text-indigo-600">Ask Question</h3></li>
                            </ul>
                            </div>
                      </div>
