...
const About = () => {
  return (
        <section>
              <div id="about" className='w-full pb-10 bg-white'>
               ...
               <div className="border-b-1 border-black mb-2"></div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 border-t border-black mb-10">
                    {/* grid cols 1 & 2 */}
                      <div className="col-span-1 pt-20 p-10">

                            <h1 className="text-4xl lg:text-5xl pb-4 font-mono">Getting Started</h1>
                            ...
                            <ul className="mt-6">
                            <li><h3 className="underline pt-2 cursor-pointer hover:text-indigo-900 hover:font-bold mx-auto p-1 justify-center">Read Our Litepaper</h3></li>
                            <li><h3 className="underline pt-2 cursor-pointer  hover:text-indigo-900 hover:font-bold mx-auto p-1 justify-center">Speak to our Ai</h3></li>
                            </ul>
                            </div>
                    ...
                    {/* grid cols 3 */}
                      <div  className="col-span-1 mt-20">
                          ...
                          <section className="invisible md:visible w-1/12 md:w-full  items-center justify-center">
                          {/* external image */}
                          <img
                          src="https://images.pexels.com/photos/3646377/pexels-photo-3646377.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                          className="w-full rounded-l-3xl border-t-4 border-r-1 border border-black shadow-2xl mx-auto"
