        ...
        <div name="hero" className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 items-center h-screen md:h-full md:pt-0 rounded-tr-3xl bg-black w-12/12 mb-0 md:mb-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 "> 
                            <div className="cols-span-1 justify-left pb-10 pt-4 md:mb-20 md:mt-10 bg-transparent  w-full ">
                                            ...
                                            <div className="w-3/3 md:w-3/3 flex justify-center items-center bg-green-400 md:bg-violet-600 border-t-4 border-2 border-green-300 md:border-indigo-900 rounded-md hover:bg-green-200 md:hover:bg-indigo-600 cursor-pointer">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 pt-4 pb-1">
