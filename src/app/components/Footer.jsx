...
const Footer = () => {
    return (
      ...
      <footer name="footer" className="bg-black text-white py-2 pt-64 p-6">
        <div className="container mx-auto flex justify-between items-center pb-40 p-3">
          <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/5 mb-4">
            ...
            <ul className="mt-2">
              <li className="mb-2"><a className="hover:text-violet-400 text-sm" href="#">About Us</a></li>
              <li className="mb-2"><a className="hover:text-violet-400 text-sm" href="#">Careers</a></li>
              <li className="mb-2"><a className="hover:text-violet-400 text-sm" href="#">Blog</a></li>
            </ul>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/5 mb-4">
            <h2 className="text-xl font-bold">Resources</h2>
            <ul className="mt-2">
              <li className="mb-2"><a className="hover:text-violet-400 text-sm" href="#">Docs</a></li>
              <li className="mb-2"><a className="hover:text-violet-400 text-sm" href="#">API</a></li>
              <li className="mb-2"><a className="hover:text-violet-400 text-sm" href="#">Support</a></li>
            </ul>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/5 mb-4">
