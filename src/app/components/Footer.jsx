    ...
    return (
      ...
      <footer name="footer" className="bg-black text-white py-2 pt-64 rounded-t-3xl">
        ...
        <div className="mx-auto items-center justify-center p-0 grid grid-cols-6">
          <div className="col-span-5 justify-start opacity-0">        
            ...
            <Link activeClass="active" to="header" smooth duration={900}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-10 h-10 rounded-3xl cursor-pointer hover:bg-gray-400 bg-gray-800 p-2">
        ...
        <div className="w-full h-px bg-green-400  my-4 opacity-50"></div>
        <div className="w-full h-px bg-green-400  my-4 opacity-50"></div>
        <div className="w-full h-px bg-green-400  my-4 opacity-60"></div>
        <div className="w-full h-px bg-green-400  my-4 opacity-60"></div>
        <div className="w-full h-0.5 bg-green-400  my-4 opacity-60"></div>
        <div className="w-full h-0.5 bg-green-400  my-4 opacity-60"></div>
        <div className="w-full h-0.5 bg-green-400  my-4 opacity-60"></div>
        <div className="w-full h-0.5 bg-green-400  my-4 opacity-70"></div>
        <div className="w-full h-0.5 bg-green-400 my-4 opacity-70"></div>
        <div className="w-full h-0.5 bg-green-400  my-4 opacity-80"></div>
        <div className="w-full h-1 bg-green-400  my-4 opacity-80"></div>
        <div className="w-full h-1 bg-green-400  my-4 opactiy-80"></div>
        <div className="w-full h-1 bg-green-400  my-4 opacity-90"></div>
        <div className="w-full h-1.5 bg-green-400 my-4 opacity-90"></div>
        <div className="w-full h-1.5 bg-green-400  my-4 opacity-90"></div>
        <div className="w-full h-2 bg-green-400  my-4 opacity-90"></div>
        <div className="w-full h-2.5 bg-green-400  my-4 opacity-100"></div>
        <div className="w-full h-3 bg-green-400 my-4 opacity-100"></div>
        <div className="w-full h-3.5 bg-green-400 my-4 opacity-100"></div>
        <div className="w-full h-4 bg-green-400  my-4 opacity-100"></div>
        <div className="w-full h-4.5 bg-green-400 opacity-100"></div>
        <div className="w-full h-5 bg-green-400 opacity-100"></div>
      </footer>
    );
  };
